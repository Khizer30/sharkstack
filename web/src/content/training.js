export const trainingContent = {
  ...
  overview: [
    "Twelve intense weeks of building real, AI-powered software — no fluffy theory, no watching from the sidelines. You'll write code, break things, and ship working projects every single week.",
    "You'll learn the way we work at SharkStack: fast, sharp, and production-first. By the end you'll have shipped an AI product you can actually put in front of people."
  ],
  curriculumHeading: "What you'll learn",
  curriculum: [
    "Foundations of modern AI and how large language models really work",
    "Prompt engineering and designing reliable AI workflows",
    "Wiring AI features into real web apps end to end",
    "Retrieval, embeddings, and giving models your own data",
