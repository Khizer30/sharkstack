...
export function ArrowUpRight({ size = 26 }) {
  return (
...
export function FinIcon({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M3.5 19.5C6 17 8.5 10.5 13.5 3.5C11.8 9 12 13 20.5 14.8C15 17.3 9 18.8 3.5 19.5Z" fill="currentColor" />
    </svg>
  );
}
...
export function LinkedinIcon({ size = 14 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.24 8.25h4.5V23H.24V8.25zM8.02 8.25h4.31v2.01h.06c.6-1.13 2.07-2.33 4.26-2.33 4.55 0 5.39 3 5.39 6.9V23h-4.5v-6.36c0-1.52-.03-3.47-2.11-3.47-2.12 0-2.44 1.65-2.44 3.36V23h-4.5V8.25z" />
    </svg>
  );
}
...
export function DribbbleIcon({ size = 14 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      <circle cx="12" cy="12" r="9.5" />
      <path d="M3.5 9.2c4.7 1.5 10.3 1.5 16.6-.4M4.4 17c3-4.3 6.8-6.7 11-7.4 2-.3 3.7-.3 5.2 0M9.3 3c2.9 3.6 4.8 8 5.4 12.9.3 2 .3 3.6.1 5" />
    </svg>
  );
}
...
export function LaptopIcon({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function UsersIcon({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M16.5 5.5a3.5 3.5 0 0 1 0 6.8M21.5 20a6 6 0 0 0-4.5-8" />
    </svg>
  );
}

export function SunburstIcon({ size = 96 }) {
  const rayCount = 16;
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round">
...
export function OrbitRingsIcon({ size = 96 }) {
  const rings = [46, 36, 26, 16];
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.4">
      {rings.map((r, i) => {
...
export function LatticeIcon({ size = 96 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.2">
      <polygon points="50,8 92,50 50,92 8,50" />
      <polygon points="50,26 74,50 50,74 26,50" />
      <polygon points="26,26 74,26 74,74 26,74" />
...
export function PhoneIcon({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.6 3.36 2 2 0 0 1 3.57 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.54a16 16 0 0 0 6.29 6.29l.92-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
    </svg>
  );
}
